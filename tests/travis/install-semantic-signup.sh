...
function installToMediaWikiRoot {
	...
	if [ "$SES" != "" ]
	then
		composer require 'mediawiki/semantic-signup='$SES --prefer-source --update-with-dependencies
	else
		composer init --stability dev
		composer require mediawiki/semantic-signup "dev-master" --prefer-source --dev --update-with-dependencies
